...
export const PLANTILLAS = [
  ...
  },
  {
    ...
    misiones: [
      { nombre: 'Prospección',        tipo: 'contador', objetivo: 20,  unidad: 'contactos', paso: 5,   xp: 40, stat: 'percepcion',   indicador: 'contactos', area: 'profesional' },
      { nombre: 'Reunión con el equipo', tipo: 'checkbox',                                            xp: 30, stat: 'percepcion', area: 'profesional' },
      { nombre: 'Uno a uno con un vendedor', tipo: 'checkbox',                                        xp: 35, stat: 'inteligencia', area: 'profesional' },
      { nombre: 'Reuniones con clientes', tipo: 'contador', objetivo: 2, unidad: 'reuniones', paso: 1, xp: 40, stat: 'percepcion',   indicador: 'reuniones', area: 'profesional' },
      { nombre: 'Propuestas enviadas', tipo: 'contador', objetivo: 3,   unidad: 'envíos',    paso: 1,  xp: 40, stat: 'percepcion',   indicador: 'propuestas', area: 'profesional' },
      { nombre: 'Formación en ventas', tipo: 'contador', objetivo: 30,  unidad: 'min',       paso: 10, xp: 35, stat: 'inteligencia', area: 'profesional' },
      ...
      { nombre: 'Ventas cerradas',    tipo: 'contador', objetivo: 1,   unidad: 'ventas',    paso: 1,  xp: 80, stat: 'percepcion',   indicador: 'cierres',  opcional: true, area: 'profesional' },
      { nombre: 'Facturación',        tipo: 'contador', objetivo: 1000, unidad: 'S/',       paso: 100, xp: 60, stat: 'inteligencia', indicador: 'ingresos', opcional: true, area: 'profesional' },
    ],
  },
  {
    id: 'gerente',
    ...
    misiones: [
      { nombre: 'Prospección',        tipo: 'contador', objetivo: 25,  unidad: 'contactos', paso: 5,   xp: 45, stat: 'percepcion',   indicador: 'contactos', area: 'profesional' },
      { nombre: 'Reunión con el equipo', tipo: 'checkbox',                                            xp: 30, stat: 'percepcion', area: 'profesional' },
      { nombre: 'Uno a uno con un vendedor', tipo: 'checkbox',                                        xp: 35, stat: 'inteligencia', area: 'profesional' },
      { nombre: 'Revisar el embudo',  tipo: 'checkbox',                                               xp: 30, stat: 'percepcion', area: 'profesional' },
      { nombre: 'Reuniones con clientes', tipo: 'contador', objetivo: 3, unidad: 'reuniones', paso: 1, xp: 45, stat: 'percepcion',   indicador: 'reuniones', area: 'profesional' },
      { nombre: 'Propuestas enviadas', tipo: 'contador', objetivo: 4,   unidad: 'envíos',    paso: 1,  xp: 45, stat: 'percepcion',   indicador: 'propuestas', area: 'profesional' },
      { nombre: 'Formación en ventas', tipo: 'contador', objetivo: 45,  unidad: 'min',       paso: 15, xp: 45, stat: 'inteligencia', area: 'profesional' },
      { nombre: 'Ventas cerradas',    tipo: 'contador', objetivo: 1,   unidad: 'ventas',    paso: 1,  xp: 90, stat: 'percepcion',   indicador: 'cierres',  opcional: true, area: 'profesional' },
      { nombre: 'Facturación',        tipo: 'contador', objetivo: 1500, unidad: 'S/',       paso: 100, xp: 70, stat: 'inteligencia', indicador: 'ingresos', opcional: true, area: 'profesional' },
    ],
  },
  {
    id: 'fisico',
